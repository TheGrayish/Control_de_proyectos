        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-16">   
                    ...
                    <a href="/main" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900">QCI-Hub</h2>
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Una plataforma que permita a estudiantes resolver, repasar y analizar los temas, dándole la oportunidad de poder aprender y
                                así les sea más fácil el aprobar la materia para evitar que se vean en la necesidad de recursar la materia por la falta de 
                                conocimiento o información que sirva relacionada al tema de interés.
                            </p>
                        </div>
